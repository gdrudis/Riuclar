...
lyr_EmpresesPolgonRiuClar_2.set('fieldAliases', {'id': 'id', '._NOM SABI': '._NOM SABI', '._NOM COMERCIAL': '._NOM COMERCIAL', '._NIF': '._NIF', '._IAE': '._IAE', '._ADREÇA': '._ADREÇA', '._Nº TELÈFON': '._Nº TELÈFON', '._WEB': '._WEB', 'numdecimal': 'numdecimal', });
...
lyr_EmpresesPolgonRiuClar_2.set('fieldImages', {'id': 'TextEdit', '._NOM SABI': 'TextEdit', '._NOM COMERCIAL': 'TextEdit', '._NIF': 'TextEdit', '._IAE': 'TextEdit', '._ADREÇA': 'TextEdit', '._Nº TELÈFON': 'TextEdit', '._WEB': 'TextEdit', 'numdecimal': 'TextEdit', });
...
lyr_EmpresesPolgonRiuClar_2.set('fieldLabels', {'id': 'hidden field', '._NOM SABI': 'header label - always visible', '._NOM COMERCIAL': 'header label - always visible', '._NIF': 'header label - always visible', '._IAE': 'header label - always visible', '._ADREÇA': 'header label - always visible', '._Nº TELÈFON': 'header label - always visible', '._WEB': 'header label - always visible', 'numdecimal': 'hidden field', });
