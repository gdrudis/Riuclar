...
lyr_EmpresesPolgonRiuClar_2.set('fieldLabels', {'id': 'hidden field', '._NOM SABI': 'header label - visible with data', '._NOM COMERCIAL': 'header label - always visible', '._NIF': 'hidden field', '._IAE': 'header label - always visible', '._ADREÇA': 'header label - always visible', '._Nº TELÈFON': 'header label - always visible', '._WEB': 'header label - always visible', 'numdecimal': 'hidden field', });
